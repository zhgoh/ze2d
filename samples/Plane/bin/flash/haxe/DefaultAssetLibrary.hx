...
@:keep class __ASSET__gfx_alien_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__gfx_heart_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__gfx_missile_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__gfx_plane_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:bitmap("assets/gfx/Alien.png") class __ASSET__gfx_alien_png extends flash.display.BitmapData {}
@:bitmap("assets/gfx/Heart.png") class __ASSET__gfx_heart_png extends flash.display.BitmapData {}
@:bitmap("assets/gfx/Missile.png") class __ASSET__gfx_missile_png extends flash.display.BitmapData {}
@:bitmap("assets/gfx/Plane.png") class __ASSET__gfx_plane_png extends flash.display.BitmapData {}
