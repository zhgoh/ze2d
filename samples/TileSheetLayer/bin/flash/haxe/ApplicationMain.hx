...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("atlas/Font.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("atlas/Font.xml");
		types.push (AssetType.TEXT);
		
		
		urls.push ("atlas/TS1.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("atlas/TS1.xml");
		types.push (AssetType.TEXT);
		
		
		urls.push ("atlas/TS2.png");
		types.push (AssetType.IMAGE);
		
		
		urls.push ("atlas/TS2.xml");
		types.push (AssetType.TEXT);
	...
	public static function main () {
		...
		#if js
		#if munit
		flash.Lib.embed (null, 290, 100, "F5F5F5");
		#end
		#else
		create ();
		#end
