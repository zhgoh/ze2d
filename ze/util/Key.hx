...
class Key 
{
	...
	public static inline var FULLSTOP:Int = 190;
	public static inline var SLASHBACKWARDS:Int = 191;
	public static inline var COLON:Int = 186;
	public static inline var SINGLEQUOTE:Int = 222;
	public static inline var SQUAREBRACKETLEFT:Int = 219;
	public static inline var SQUAREBRACKETRIGHT:Int = 221;
	public static inline var SLASHFORWARD:Int = 220;
	
	public static inline var BACKTICK:Int = 192;
